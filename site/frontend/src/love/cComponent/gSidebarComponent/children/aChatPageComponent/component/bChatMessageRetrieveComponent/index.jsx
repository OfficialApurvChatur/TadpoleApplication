    ...
    <>
      <Card 
        className={`
          ...
          bg-[#F0EDCC] dark:bg-[#02343F]
          border-[#02343F] dark:border-[#F0EDCC]
          text-[#02343F] dark:text-[#F0EDCC]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#02343F] dark:border-[#F0EDCC]">
        ...
        <CardFooter className="py-2 border-y border-[#02343F] dark:border-[#F0EDCC] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#02343F] dark:border-[#F0EDCC]"
              autoComplete="off"
              value={input}
